...
-(void)createImageView:(CGFloat)height_y imageUrl:(NSString*)imageUrl{
    ...
    [imageView sd_setImageWithURL:[NSURL URLWithString:[[NSString stringWithFormat:@"%@%@",SmallPic,imageUrl] stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding]] placeholderImage:[UIImage imageNamed:@"default"]];
