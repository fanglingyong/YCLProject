...
//        frame.size.width=[stageLabel stageLabelWidth];
        ...
        frame.origin.x = CGRectGetMinX(stageLabel.frame) + [stageLabel stageLabelOriginX] + ([stageLabel stageLabelWidth] / 2) - WidthXiShu(7);
        frame.size.width = WidthXiShu(14);
    }
