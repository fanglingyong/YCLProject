...
-(void)updateinfo{
    [_medicineImg sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@%@",SmallPic,_model.goodspic]] placeholderImage:[UIImage imageNamed:@"sysIcon3.jpg"]];//药品图片
